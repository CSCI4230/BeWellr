     ...
     <div class="imageContainer">
         ...
         <a class = "facts" href="#popup1"><img id="food" src="images/food.png"></a>
            <div id="popup1" class="overlay">
	           <div class="popup">
                    <p>An average woman needs to eat about 2000 calories per day to maintain, and 1500 calories to lose one pound of weight per week. An average man needs 2500 calories to maintain, and 2000 to lose one pound of weight per week. <a href="https://authoritynutrition.com/how-many-calories-per-day/" target="_blank">Click Here for more information</a></p><a class="close" href="#">&times;</a></div></div>
         
         <a class = "facts" href="#popup2"><img id="fruit" src="images/fruit.png"></a>
         <div id="popup2" class="overlay">
	           <div class="popup">
                    <p>According to the 2005 Dietary Guidelines for Americans, you should consume between five and 13 servings of fruits and vegetables each day. <a href="http://healthyeating.sfgate.com/many-fruits-veggies-should-eat-day-3324.html" target="_blank">Click Here for more information</a></p><a class="close" href="#">&times;</a></div></div>
